...
use std::str::FromStr;
use syntect::highlighting::{Color, ScopeSelectors, StyleModifier, Theme, ThemeSet, ThemeSettings};
...
fn create_vscode_light_modern_theme() -> Theme {
    ...
    let items = vec![
        // Comments - green
        ThemeItem {
            scope: ScopeSelectors::from_str("comment")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
                    g: 0x80,
        ...
        // Strings - red/maroon
        ThemeItem {
            scope: ScopeSelectors::from_str("string")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0xA3,
        ...
        // Numbers - teal
        ThemeItem {
            scope: ScopeSelectors::from_str("constant.numeric")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x09,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("entity.name.function, support.function")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x79,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str(
                "support.class, support.type, entity.name.type, storage.type",
            )
            .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("keyword.control")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        // Variables - dark blue
        ThemeItem {
            scope: ScopeSelectors::from_str("variable, entity.name.variable")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("keyword, storage, storage.modifier")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("keyword.operator")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("constant.language")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("constant.character")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("variable.language")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("entity.name.tag")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x80,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("entity.other.attribute-name")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0xFF,
        ...
        ThemeItem {
            scope: ScopeSelectors::from_str("meta.preprocessor")
                .expect("Built-in theme scope selector should be valid"),
            style: StyleModifier {
                foreground: Some(Color {
                    r: 0x00,
...
mod tests {
    ...
    fn test_theme_preset_parsing() {
        assert_eq!(
            ThemePreset::from_str("vscode-dark"),
            Some(ThemePreset::VsCodeDark)
        );
        assert_eq!(
            ThemePreset::from_str("VsCode_Dark"),
            Some(ThemePreset::VsCodeDark)
        );
        assert_eq!(
            ThemePreset::from_str("jetbrains-darcula"),
            Some(ThemePreset::JetBrainsDarcula)
        );
        assert_eq!(
            ThemePreset::from_str("darcula"),
            Some(ThemePreset::JetBrainsDarcula)
        );
